function tsp_hk(distance_matrix) {
    ...
    shortestTour = heldKarpTSP(distance_matrix, visited, start, numOfCities);

    return shortestTour;

}

function heldKarpTSP(cities, visited, currentCity, numOfCities) {
    ...
    for(let nextCity = 0; nextCity < numOfCities; nextCity++) {
        ...
        let distanceWeight = cities[currentCity][nextCity] + heldKarpTSP(cities, visited, nextCity, numOfCities);
